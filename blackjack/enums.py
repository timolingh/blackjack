...
class StatsCategory(Enum):
    ...
    MEAN_EARNINGS_PER_HAND = 'MEAN EARNINGS PER HAND'
    EARNINGS_SUM_OF_SQUARED_DIFFERENCES = 'EARNINGS SUM OF SQUARED DIFFERENCES'
    EARNINGS_VARIANCE = 'EARNINGS VARIANCE'
    EARNINGS_STD_DEV = 'EARNINGS STD DEV'
